...
2. Los usuarios locales y funciones. El archivo "JBossWS-users.properties" controla el acceso del usuario al servidor como parte del dominio de archivos local. Por favor, modifique el archivo que contiene los usuarios y contraseñas que desea autenticar. El archivo "JBossWS-roles.properties" debe ser modificada para contener el nombre de usuario + "=" y el grupo "MultiGame" para todos los usuarios creado en el archivo JBossWS-users.properties para que puedan tener acceso a multi-partida.
