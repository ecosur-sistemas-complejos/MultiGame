package mx.ecosur.multigame.oculto
{
	...
	public class PlayersViewer extends Accordion
	{
        ...
        public function setTurn(player:OcultoPlayer):void{
            var pi:PlayerInfo;
         ...
         * @param player
         */
        public function getPlayerButton(player:OcultoPlayer):Button{
        ...
        public function updatePlayers():void{
            ...
            for (var i:int = 0; i < _players.length; i++){
                ...
                var btn:Button = null;
                var manPlayer:OcultoPlayer = null;            	            	
            	
                manPlayer = OcultoPlayer(_players[i]);
