package mx.ecosur.multigame.oculto
{
    ...
    import mx.ecosur.multigame.oculto.entity.OcultoMove;
	...
	public class MoveViewer extends Panel
	{
        ...
        public function set selectedMove(move:OcultoMove):void{
            var mi:MoveInfo;
        ...
        public function initFromMoves(moves:ArrayCollection):void{
            ...
            for (var i:int = 0; i < moves.length; i++){
                addMove(OcultoMove(moves[i]));                   
            }
            if(moves.length > 0){
                this.selectedMove = OcultoMove(moves[moves.length - 1]); 
            }
        }
         ...
         */
        public function addMove(move:OcultoMove):void{
         ...
         * 
         */
        public function updateMove(move:OcultoMove):void{
        ...
        private function goBack(event:MouseEvent):void{
            ...
            var move:OcultoMove = MoveInfo(_moves.getChildAt(ind - 1)).gameMove;
            var moveEvent:DynamicEvent = new DynamicEvent(MOVE_EVENT_GOTO_MOVE);
            moveEvent.move = move;
            dispatchEvent(moveEvent);
        }
