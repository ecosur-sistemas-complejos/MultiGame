...
import mx.ecosur.multigame.component.AbstractBoard;
    ...
    /**	
    * A OcultoBoard is similar to the ManantialesBoard implementation,
    *
    ...
    * living in the Ejido.
    *
    * The board is used to regulate the display of user and enemy
    * tokens.
    *
    */ 
	public class OcultoBoard extends AbstractBoard {
        ...
        override public function addToken(token:Token):void{
            ...
            var ocultoToken:OcultoToken = OcultoToken (token);
