package mx.ecosur.multigame.oculto
{
	...
	public class MoveViewer extends Panel
	{
        ...
        public function set selectedMove(move:TablonMove):void{
            var mi:MoveInfo;
        ...
        public function initFromMoves(moves:ArrayCollection):void{
            ...
            for (var i:int = 0; i < moves.length; i++){
                addMove(TablonMove(moves[i]));
            }
            if(moves.length > 0){
                this.selectedMove = TablonMove(moves[moves.length - 1]);
            }
        }
         ...
         */
        public function addMove(move:TablonMove):void{
         ...
         * 
         */
        public function updateMove(move:TablonMove):void{
        ...
        private function goBack(event:MouseEvent):void{
            ...
            var move:TablonMove = MoveInfo(_moves.getChildAt(ind - 1)).gameMove;
            var moveEvent:DynamicEvent = new DynamicEvent(MOVE_EVENT_GOTO_MOVE);
            moveEvent.move = move;
            dispatchEvent(moveEvent);
        }
