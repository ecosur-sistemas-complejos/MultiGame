package mx.ecosur.multigame.oculto
{
	...
	public class TablonGameController
	{
        ...
        public function initializeTokenStorePanel (tokenStorePanel:Panel):void {
        	var _store:TablonTokenStore = TablonTokenStore(
        ...
        public function dragEnterBoardCell(evt:DragEvent):void{
            ...
            if (evt.dragSource.hasFormat("token")){
                ...
                var token:TablonToken = TablonToken(evt.dragSource.dataForFormat("token"));
        ...
        private function validateMove(boardCell:RoundCell, token:TablonToken):Boolean
        {
        ...
        private function startMove(evt:MouseEvent):void{
            ...
            if (!_isMoving && _isTurn){
                ...
                var token:TablonToken = TablonToken(evt.currentTarget);
        ...
        private function endDoMove(event:EffectEvent):void{
            ...
            var token:TablonToken = TablonToken(AnimateProperty(event.currentTarget).target);
        ...
        private function undoMove(move:TablonMove):void{
            ...
            //create new token
            var token:TablonToken = new OcultoToken();
            token.cell = move.destinationCell;
            token.width = endSize;
            token.height = endSize;
            _gameWindow.animateLayer.addChild(token);
